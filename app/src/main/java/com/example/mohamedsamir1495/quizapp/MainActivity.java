package com.example.mohamedsamir1495.quizapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    final String Q3_ANSWER = "ubisoft";
    final String Q4_ANSWER = "Odyssey";
    ...
    public void checkQuiz(View v) {
        ...
        CharSequence text;
        if (numberOfQuestionsCorrect < 4)
            text = "You got " + numberOfQuestionsCorrect + "/4 answers right.\n\nRecheck the following:\n" + sb.toString();
        else
            text = "Congrats u answered all questions correctly :)";
